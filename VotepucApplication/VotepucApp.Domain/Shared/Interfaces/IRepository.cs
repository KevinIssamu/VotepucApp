...
public interface IRepository<T> where T : IAggregateRoot
{
    ...
    Task<OneOf<T, AppError.AppError>> SelectByIdAsNoTrackingAsync(Guid id, CancellationToken cancellationToken);
    Task<OneOf<T, AppError.AppError>> SelectByIdTrackingAsync(Guid id, CancellationToken cancellationToken);
